...
class Factory(threading.Thread):
    ...
    def __init__(self, shopper, sema_4_supply, sema_4_demand):
...
class Dealer(threading.Thread):
    ...
    def __init__(self, shopper, sema_4_supply, sema_4_demand, queue_stats):
...
def main():
    ...
    for _ in range(MAX_QUEUE_SIZE):
        sema_4_supply.acquire() # although the semaphore has size 10, it starts out unavailable
    ...
    factory = Factory(shopper, sema_4_supply, sema_4_demand)

    # TODO create your one dealership
    dealer = Dealer(shopper, sema_4_supply, sema_4_demand, queue_stats)
